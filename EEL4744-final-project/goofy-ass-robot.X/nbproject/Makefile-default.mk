...
${OBJECTDIR}/main.obj: main.asm  nbproject/Makefile-${CND_CONF}.mk 
	...
	${MP_AS}  -fI -W+ie ${PACK_ASSEMBLER_OPTIONS} -d ${DISTDIR}/goofy-ass-robot.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  -m ${DISTDIR}/goofy-ass-robot.X.${IMAGE_TYPE}.map  -S ${DISTDIR}/goofy-ass-robot.X.${IMAGE_TYPE}.tmp main.asm
else
${OBJECTDIR}/main.obj: main.asm  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} ${DISTDIR} 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/main.obj 
	${MP_AS}  -fI -W+ie ${PACK_ASSEMBLER_OPTIONS} -d ${DISTDIR}/goofy-ass-robot.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  -S ${DISTDIR}/goofy-ass-robot.X.${IMAGE_TYPE}.tmp  -o ${DISTDIR}/goofy-ass-robot.X.${IMAGE_TYPE}.hex  -m ${DISTDIR}/goofy-ass-robot.X.${IMAGE_TYPE}.map  -l ${DISTDIR}/goofy-ass-robot.X.${IMAGE_TYPE}.lss main.asm
endif
